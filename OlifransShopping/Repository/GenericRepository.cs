...
namespace OlifransShopping.Repository
{
    public class GenericRepository<Tbl_Entity> : IRepository<Tbl_Entity> where Tbl_Entity : class
    {
        DbSet<Tbl_Entity> _dbSet;
        private OlifransShoppingEntities _DBEntity;

        public GenericRepository(OlifransShoppingEntities DBEntity)
        {
            _DBEntity = DBEntity;
        ...
        public IEnumerable<Tbl_Entity> GetProduto()
        {
            return _dbSet.ToList();
        }
